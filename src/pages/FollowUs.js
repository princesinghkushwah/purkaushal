...
export default function Index() {
    return (
        <div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-40 md:px-6 py-16 px-5 w-full flex flex-col sm:flex-row items-center">
            <div className=" text-center">
                <h2 className="lg:text-5xl heading text-4xl leading-9 text-gray-800 md:w-full pr-4 mx-auto">Follow Us on Instagram</h2>
                <p className=" font-normal text-base leading-6 text-gray-600 mt-4 lg:w-5/12 md:w-9/12 mx-auto">
                    Follow us on instagram @<br></br><span className="underline cursor-pointer">followuspleaseee</span> and tag us to get featured on our timeline
                </p>
            </div>
            <div className="lg:w-10/12 grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-4 md:grid-cols-3 lg:grap-8 md:gap-6 gap-4 mt-6">
